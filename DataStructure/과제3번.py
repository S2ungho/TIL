...
class LinkedListBasic:
        ...
        def middle(self): #중간값 리턴하는 메소드 구현  
                a = self.size()
                x = int(a/2)
                print("가운뎃 값 :",self.get(x))
        

#메소드 실행해보기
import time

llist = LinkedListBasic()

for k in range(0,11,1): #홀수개 11개 생성  
    llist.append(k)
        
print("원소가 잘 생성되었는지 확인 :", end =' ')
llist.printList()

llist.middle()
#만든 메소드 실행 - 0~11 까지 11개 원소 생성 후 가운뎃값 4출력  
