...
p1.setFillColor("pink")
p1.setBorderColor("pink")
...
car = Layer()
leg1 = Path(Point(-10, -10),Point(-10, 0))
leg1.setBorderWidth(3)
car.add(leg1)
leg2 = Path(Point(10, -10),Point(10, 0))
leg2.setBorderWidth(3)
car.add(leg2)
arm1 = Path(Point(10, -10),Point(0, 0))
arm1.setBorderWidth(3)
car.add(arm1)
body = Circle(20, Point(0, -25))
